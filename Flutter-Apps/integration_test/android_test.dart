...
void main() {
  ...
  group('Android Integration Test', () {
    testWidgets('Basic app functionality test', (tester) async {
      // Start the app
      await tester.pumpWidget(const app.MyApp());
      await tester.pumpAndSettle();

      // Test 1: Verify app title
      ...
      // Test 4: Test increment button (using icon finder to avoid key issues)
      ...
      print('✅ Android integration test passed successfully!');
    });
  });
}
